...
Im Laufe don Versuch 1 wurden folgende Messwerte aufgenommen, auf die sich in der folgenden Auswertung bezogen wird: 
```{r, echo = FALSE}
...
Aus dem Zusammenhang $T=2*\pi*\sqrt{\frac{l}{g}}$ ergibt sich mit $L = 0,8744m$ und $T = 1,878s$:
...
Zur Validierung der Messwerte wurde die Funktion $T(L)=2\pi\sqrt{\frac{L}{g}}$ mit dem Literaturwert der Erdbeschleunigung für Berlin von $g\approx 9,81\frac{m}{s^2}$ eingezeichnet. 
...
Bekannt ist: $T^2 = 4\pi^2\frac{L}{g}$.
Daraus folgt eine Geradengleichung der Form $T^2=a*L+y$ mit der Steigung $a=\frac{4\pi^2}{g}$ und dem y-Achsenabschnitt $y$.
