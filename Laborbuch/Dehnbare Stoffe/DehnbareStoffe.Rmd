...
```
Sowohl aus Gründen der Vergleichbarkeit werden auch bei der Berechnung eines Mittelwertes der Federkonstante in diesem Versuch die Werte für $x_i<0,05m$ verworfen.
Zudem wird in dem Federkonstante-Auslenkung-Schaubild auch deutlich, dass für die Werte kleiner als ~5cm Auslenkung die Federkonstante keinen Stabilen Wert annimmt.
...
```
Die in Versuch 2 bestimmte Federkonstante für eine Ausdehnung des Gummis über $5cm$ beträgt: $D_2=(13,10 \pm 0,31)\frac{N}{m}$.
