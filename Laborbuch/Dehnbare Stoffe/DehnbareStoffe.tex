...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Entfernen von NA{-}Zeilen}
...
\CommentTok{\# Umrechnung in kg}
\NormalTok{Messreihe2}\SpecialCharTok{$}\NormalTok{Auslenkung2\_x0\_m }\OtherTok{\textless{}{-}}\NormalTok{ Messreihe2}\SpecialCharTok{$}\NormalTok{Auslenkung2\_x0}\SpecialCharTok{/}\DecValTok{1000}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{ggplot}\NormalTok{(Messreihe2, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ Auslenkung2\_x0\_m, }\AttributeTok{y =}\NormalTok{ Kraft, }
                      \AttributeTok{ymin =}\NormalTok{ Kraft}\SpecialCharTok{{-}}\NormalTok{u\_Kraft, }\AttributeTok{ymax =}\NormalTok{ Kraft}\SpecialCharTok{+}\NormalTok{u\_Kraft)) }\SpecialCharTok{+} 
  \CommentTok{\#geom\_point(size=0.1) + }
  \FunctionTok{geom\_errorbar}\NormalTok{(}\AttributeTok{width =} \FloatTok{0.0005}\NormalTok{) }\SpecialCharTok{+} 
  \FunctionTok{geom\_errorbar}\NormalTok{(}\AttributeTok{width =} \FloatTok{0.0005}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{xlab}\NormalTok{(}\StringTok{"Auslenkung x [m]"}\NormalTok{) }\SpecialCharTok{+} \FunctionTok{ylab}\NormalTok{(}\StringTok{"Kraft F [N]"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_errorbarh}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{xmin =}\NormalTok{ Auslenkung2\_x0\_m}\SpecialCharTok{{-}}\NormalTok{u\_x,}
                     \AttributeTok{xmax =}\NormalTok{ Auslenkung2\_x0\_m}\SpecialCharTok{+}\NormalTok{u\_x))}
\end{Highlighting}
\end{Shaded}

\includegraphics{DehnbareStoffe_files/figure-latex/unnamed-chunk-13-1.pdf}
Federkonstante-Auslenkung Diagramm:

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ymini }\OtherTok{\textless{}{-}}\NormalTok{ Messreihe2}\SpecialCharTok{$}\NormalTok{Federkonstante2}\SpecialCharTok{{-}}\NormalTok{Messreihe2}\SpecialCharTok{$}\NormalTok{u\_Federkonstante2}
\NormalTok{ymini[}\FunctionTok{which}\NormalTok{(ymini}\SpecialCharTok{\textless{}}\DecValTok{0}\NormalTok{)] }\OtherTok{\textless{}{-}} \DecValTok{0}
\FunctionTok{ggplot}\NormalTok{(Messreihe2, }
       \FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ Auslenkung2\_x0\_m, }\AttributeTok{y =}\NormalTok{ Federkonstante2, }
       \AttributeTok{ymin =}\NormalTok{ Federkonstante2}\SpecialCharTok{{-}}\NormalTok{u\_Federkonstante2, }
       \AttributeTok{ymax =}\NormalTok{ Federkonstante2}\SpecialCharTok{+}\NormalTok{u\_Federkonstante2)) }\SpecialCharTok{+} 
  \FunctionTok{geom\_point}\NormalTok{(}\AttributeTok{size=}\FloatTok{0.1}\NormalTok{) }\SpecialCharTok{+} 
  \FunctionTok{geom\_errorbar}\NormalTok{(}\AttributeTok{width =} \FloatTok{0.001}\NormalTok{) }\SpecialCharTok{+} 
  \FunctionTok{geom\_errorbar}\NormalTok{(}\AttributeTok{width =} \FloatTok{0.001}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{xlab}\NormalTok{(}\StringTok{"Auslenkung x [m]"}\NormalTok{) }\SpecialCharTok{+} \FunctionTok{ylab}\NormalTok{(}\StringTok{"Federkonstante D [N/m]"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_errorbarh}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{xmin =}\NormalTok{ Auslenkung2\_x0\_m}\SpecialCharTok{{-}}\NormalTok{u\_x,}
                     \AttributeTok{xmax =}\NormalTok{ Auslenkung2\_x0\_m}\SpecialCharTok{+}\NormalTok{u\_x))}
\end{Highlighting}
\end{Shaded}

\includegraphics{DehnbareStoffe_files/figure-latex/unnamed-chunk-14-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{printdf2 }\OtherTok{\textless{}{-}} \FunctionTok{cbind}\NormalTok{(Messreihe[,}\FunctionTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{5}\NormalTok{,}\DecValTok{10}\NormalTok{)], }\FunctionTok{round}\NormalTok{(Messreihe[,}\DecValTok{8}\NormalTok{], }\DecValTok{7}\NormalTok{),}
                 \FunctionTok{round}\NormalTok{(Messreihe[,}\DecValTok{12}\NormalTok{], }\DecValTok{4}\NormalTok{), }\FunctionTok{round}\NormalTok{(Messreihe[,}\DecValTok{13}\NormalTok{], }\DecValTok{5}\NormalTok{))}
\FunctionTok{colnames}\NormalTok{(printdf2) }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{"n\_m[{-}]"}\NormalTok{, }\StringTok{"L2[cm]"}\NormalTok{, }\StringTok{"m[kg]"}\NormalTok{, }\StringTok{"u\_m[kg]"}\NormalTok{, }\StringTok{"F[N]"}\NormalTok{, }\StringTok{"u\_F[N]"}\NormalTok{)}
\NormalTok{printdf2 }\OtherTok{\textless{}{-}}\NormalTok{ printdf2[}\FunctionTok{which}\NormalTok{(}\FunctionTok{is.na}\NormalTok{(printdf2}\SpecialCharTok{$}\StringTok{\textasciigrave{}}\AttributeTok{L2[cm]}\StringTok{\textasciigrave{}}\NormalTok{)}\SpecialCharTok{==}\ConstantTok{FALSE}\NormalTok{),]}
\NormalTok{printdf2[, }\FunctionTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{3}\NormalTok{,}\DecValTok{4}\NormalTok{,}\DecValTok{2}\NormalTok{,}\DecValTok{5}\NormalTok{,}\DecValTok{6}\NormalTok{)]}
\end{Highlighting}
\end{Shaded}
