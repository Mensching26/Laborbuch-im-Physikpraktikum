...
messwerte <- data.frame(Messwert = c(235.5, 97.4, 235.5-97.4, 23.00, 50.000, 44.2),
                        ...
                        Skaleneinheit = c(0.1, 0.1, "-", 1, 0.1, 0.1),
...
<!--         = \sqrt{ (\frac{(1+m_w*c_w)*(T_M-T_B)}{m_F*(T_A-T_B)}u_{C_K})^2+ -->
<!--                  (\frac{(C_K+c_w)(T_M-T_B)}{mF(T_A-T_M)}*u_{m_w})^2+(\frac{(C_K+m_w*c_w)*(1-T_B)}{mF(T_A-1)}*u_{T_M})^2+ -->
<!--                  (\frac{(C_K+m_w*c_w)*(T_M-1)}{mF(T_A-T_M)}*u_{T_B})^2+(\frac{(C_K+m_w*c_w)*(T_M-T_B)}{T_A-T_M}*u_{m_F})^2+ -->
<!--                  (\frac{(C_K+m_w*c_w)*(T_M-T_B)}{mF(1-T_M)}*u_{T_A})^2} -->
<!-- \end{equation} -->
