...
```{r, echo=FALSE}
# Messgrößen
groesse = c("Becherglas mit Wasser [g]", "Masse Becherglas [g]", "Wassermasse [g]", "Metallmasse [g]", "Metallvolumen [ml]", "Anfangstemperatur [°C]", "Mischtemperatur [°C]")
messwerte <- data.frame(Messwert = c(235.5, 97.4, 235.5-97.4, 198.0,23.00, 50.000, 44.2),
                        Geräteart = c("digital", "digital", "-", "digital", "analog", "digital", "digital"),
                        Skaleneinheit = c(0.1, 0.1, "-", 0.1, 1, 0.1, 0.1),
                        Unsicherheit = c(0.029, 0.029, 2*0.029, 0.029, 0.20, 0.029, 0.029)
                        )
...
```{r, echo=FALSE}
# Messgrößen
groesse = c("Becherglas mit Wasser [g]", "Masse Becherglas [g]", "Wassermasse [g]", "Metallmasse [g]", "Metallvolumen [cm³]", "Anfangstemperatur []", "Mischtemperatur [K]", "Raumtemperatur [K]")
messwerte <- data.frame(Messwert = c(241.3, 97.4, 241.3-97.4, 176.12,22.00, 273.150+49.100, 273.150+42.8, 273.15+20.0),
